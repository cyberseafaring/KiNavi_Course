...
1. Open the `index.html` file for editing.
2. Locate the line `<title>Docsify Open MultiCourse Starter Kit</title>` and change the text between the title tags to be displayed as the site name on the Browser tab
3. Locate the line `name: 'Docsify Open MultiCourse Starter Kit',` and change the text between the quotes to be displayed as the site name at the top of the Docsify Sidebar
